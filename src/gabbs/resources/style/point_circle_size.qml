...
<qgis version="2.10.1-Pisa" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="FireType">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="AcresBurned">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    ...
    <edittype widgetv2type="TextEdit" name="WFID">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="TRS">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="Status">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="FireClass">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="County">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="fpa_name">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 attr="AcresBurned" symbollevels="0" type="graduatedSymbol" graduatedMethod="GraduatedSize">
    <ranges>
      <range render="true" symbol="0" lower="10.000000" upper="166.666667" label=" 10 - 167 "/>
      <range render="true" symbol="1" lower="166.666667" upper="323.333333" label=" 167 - 323 "/>
      <range render="true" symbol="2" lower="323.333333" upper="480.000000" label=" 323 - 480 "/>
      <range render="true" symbol="3" lower="480.000000" upper="636.666667" label=" 480 - 637 "/>
      <range render="true" symbol="4" lower="636.666667" upper="793.333333" label=" 637 - 793 "/>
      <range render="true" symbol="5" lower="793.333333" upper="950.000000" label=" 793 - 950 "/>
    </ranges>
    <symbols>
  ...
  <displayfield>fpa_name</displayfield>
  <label>0</label>
  <labelattributes>
